...
class Admin extends CI_Controller
{
    ...
    public function user_roles()
    {
        ...
        $this->template->loadContent("admin/user_roles.php", [
                "roles" => $roles,
            ]
        );
    }
    ...
    public function edit_user_role($id)
    {
        ...
        $this->template->loadContent("admin/edit_user_role.php", [
                "role" => $role->row(),
            ]
        );
    }
    ...
    public function premium_users()
    {
        ...
        $this->template->loadData("activeLink",
            ["admin" => ["premium_users" => 1]]);

        $this->template->loadContent("admin/premium_users.php", [
            ]
        );
    }
    ...
    public function premium_users_page()
    {
        ...
        foreach ($members->result() as $r) {
            ...
            $this->datatables->data[] = [
                $this->common->get_user_display(["username"         => $r->username,
                                                 "avatar"           => $r->avatar,
    ...
    public function user_polls($userid, $page = 0)
    {
        ...
        $this->template->loadContent("admin/user_polls.php", [
                "polls" => $polls,
                "user"  => $user->row(),
            ]
        );
    ...
    public function manage_polls($page = 0)
    {
        ...
        $this->template->loadContent("admin/polls.php", [
    ...
    public function poll_page()
    {
        ...
        foreach ($polls->result() as $r) {
            ...
            $this->datatables->data[] = [
                ...
                '<a href="' . site_url("polls/view_poll/" . $r->ID . "/" . $r->hash) . '" class="btn btn-primary btn-xs">' . lang("ctn_335") . '</a> <a href="' . site_url("polls/edit_poll_pro/" . $r->ID) . '" class="btn btn-info btn-xs" title="' . lang("ctn_379") . '" data-toggle="tooltip" data-placement="bottom">Settings</a> <a href="' . site_url("polls/edit_poll/" . $r->ID) . '" class="btn btn-warning btn-xs" title="' . lang("ctn_358") . '"><span class="glyphicon glyphicon-cog"></span></a> <a href="' . site_url("admin/delete_poll/" . $r->ID . "/" . $this->security->get_csrf_hash()) . '" class="btn btn-danger btn-xs" onclick="return confirm(\'' . lang("ctn_386") . '\')" title="' . lang("ctn_387") . '" data-toggle="tooltip" data-placement="bottom"><span class="glyphicon glyphicon-trash"></span></a>',
            ];
        }
        echo json_encode($this->datatables->process());
    }
    ...
    public function poll_themes()
    {
        ...
        $this->template->loadData("activeLink",
            ["admin_poll" => ["poll_themes" => 1]]);

        $themes = $this->polls_model->get_poll_themes();

        $this->template->loadContent("admin/poll_themes.php", [
                "themes" => $themes,
            ]
        );
    }
    ...
    public function edit_poll_theme($id)
    {
        ...
        $this->template->loadContent("admin/edit_poll_theme.php", [
                "theme" => $theme->row(),
            ]
        );
    }
    ...
    public function edit_poll_theme_pro($id)
    {
        ...
        // Add
        $this->polls_model->update_poll_theme($id, [
                "name"     => $name,
                "css_code" => $css_code,
            ]
        );
    ...
    public function add_poll_theme()
    {
        ...
        // Add
        $this->polls_model->add_poll_theme([
                "name"     => $name,
                "css_code" => $css_code,
            ]
        );
    ...
    public function poll_settings()
    {
        ...
        $this->template->loadData("activeLink",
            ["admin_poll" => ["poll_settings" => 1]]);
        $this->template->loadContent("admin/poll_settings.php", [
            ]
        );
    }
    ...
    public function payment_logs()
    {
        ...
        $this->template->loadData("activeLink",
            ["admin" => ["payment_logs" => 1]]);

        $this->template->loadContent("admin/payment_logs.php", [
            ]
        );
    }
    ...
    public function payment_plans()
    {
        ...
        $this->template->loadData("activeLink",
            ["admin" => ["payment_plans" => 1]]);
        $plans = $this->admin_model->get_payment_plans();

        $this->template->loadContent("admin/payment_plans.php", [
                "plans" => $plans,
            ]
        );
    }
    ...
    public function add_payment_plan()
    {
        ...
        $this->admin_model->add_payment_plan([
                "name"        => $name,
                "cost"        => $cost,
                "hexcolor"    => $color,
                "days"        => $days,
    ...
    public function edit_payment_plan($id)
    {
        ...
        $this->template->loadContent("admin/edit_payment_plan.php", [
                "plan" => $plan->row(),
            ]
        );
    }
    ...
    public function edit_payment_plan_pro($id)
    {
        ...
        $this->admin_model->update_payment_plan($id, [
                "name"        => $name,
                "cost"        => $cost,
                "hexcolor"    => $color,
                "days"        => $days,
    ...
    public function payment_settings()
    {
        ...
        $this->template->loadData("activeLink",
            ["admin" => ["payment_settings" => 1]]);
        $this->template->loadContent("admin/payment_settings.php", [
            ]
        );
    }
    ...
    public function email_members()
    {
        ...
        $this->template->loadData("activeLink",
            ["admin" => ["email_members" => 1]]);
        $groups = $this->admin_model->get_user_groups();
        $this->template->loadContent("admin/email_members.php", [
                "groups" => $groups,
            ]
        );
    }
    ...
    public function user_groups()
    {
        ...
        $this->template->loadData("activeLink",
            ["admin" => ["user_groups" => 1]]);
        $groups = $this->admin_model->get_user_groups();
        $this->template->loadContent("admin/groups.php", [
                "groups" => $groups,
            ]
        );
    }
    ...
    public function edit_group($id)
    {
        ...
        $this->template->loadContent("admin/edit_group.php", [
                "group" => $group->row(),
            ]
        );
    }
    ...
    public function view_group($id, $page = 0)
    {
        ...
        $this->template->loadContent("admin/view_group.php", [
                "group"         => $group->row(),
                "users"         => $users,
    ...
    {
        if (!$this->common->has_permissions(["admin"], $this->user)) {
            $this->template->error(lang("error_2"));
        }
        $this->template->loadData("activeLink",
            ["admin" => ["email_templates" => 1]]);
        $email_templates = $this->admin_model->get_email_templates();
        $this->template->loadContent("admin/email_templates.php", [
    ...
    public function edit_email_template($id)
    {
        ...
        $this->template->loadContent("admin/edit_email_template.php", [
    ...
    public function ipblock()
    {
        ...
        $this->template->loadContent("admin/ipblock.php", [
                "ipblock" => $ipblock,
            ]
        );
    }
    ...
    public function members()
    {
        ...
        $this->template->loadContent("admin/members.php", [
    ...
    public function edit_member($id)
    {
        ...
        $this->template->loadContent("admin/edit_member.php", [
                "member"      => $member,
    ...
    public function social_settings()
    {
        ...
        $this->template->loadData("activeLink",
            ["admin" => ["social_settings" => 1]]);
        $this->template->loadContent("admin/social_settings.php", [
            ]
        );
    }
