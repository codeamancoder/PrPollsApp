...
<html lang="en">
    <head>
        ...
        <link href="<?php echo base_url();?>styles/layouts/dark_fire/dashboard.css" rel="stylesheet" type="text/css">
      ...
      <div class="row">
        ...
        <div class="user-sidebar-area">
          ...
          <div class="media-body">
            <p class="no-p-margin"><?php echo lang("ctn_503") ?> <?php echo $this->user->info->first_name ?></p>
