...
<html lang="en">
    <head>
        ...
        <link href="<?php echo base_url();?>bootstrap/css/bootstrap-theme.min.css" rel="stylesheet" media="screen">
         ...
         <!-- Styles -->
        <link href="<?php echo base_url();?>styles/layouts/bluelight/main.css" rel="stylesheet" type="text/css">
        <link href="<?php echo base_url();?>styles/layouts/bluelight/dashboard.css" rel="stylesheet" type="text/css">
        <link href="<?php echo base_url();?>styles/layouts/bluelight/responsive.css" rel="stylesheet" type="text/css">
    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <hr>
        <p class="align-center small-text"><?php echo lang("ctn_170") ?> <a href="https://www.fibosoft.com/">Fibosoft</a><br /> <?php echo $this->settings->info->site_name ?> V<?php echo $this->settings->version ?> - <a href="<?php echo site_url("home/change_language") ?>"><?php echo lang("ctn_171") ?></a></p>
