...
<div class="db-header clearfix">
    ...
    <div class="db-header-extra"> <a href="<?php echo site_url("funds/payment_log") ?>" class="btn btn-info btn-sm"><?php echo lang("ctn_492") ?></a>
</div>
</div>
...
<?php if($stripe !==null)  : ?>
<hr>
<h3><?php echo lang("ctn_488") ?></h3>
<p><?php echo lang("ctn_489") ?></p>
...
<form action="<?php echo site_url("IPN/stripe/1") ?>" method="POST">
  <script
    ...
    data-amount="500"
    data-label="<?php echo lang("ctn_491") ?> <?php echo $this->settings->info->payment_symbol ?>5.00 <?php echo lang("ctn_490") ?>"
    data-name="<?php echo $this->settings->info->payment_symbol ?>5.00 for <?php echo $this->settings->info->site_name ?>"
    data-description="<?php echo lang("ctn_490") ?>"
...
<form action="<?php echo site_url("IPN/stripe/2") ?>" method="POST">
  <script
    ...
    data-key="<?php echo $stripe['publishable_key']; ?>"
    data-amount="1000"
    data-label="<?php echo lang("ctn_491") ?> <?php echo $this->settings->info->payment_symbol ?>10.00 <?php echo lang("ctn_490") ?>"
...
<form action="<?php echo site_url("IPN/stripe/3") ?>" method="POST">
  <script
    ...
    data-key="<?php echo $stripe['publishable_key']; ?>"
    data-amount="3000"
    data-label="<?php echo lang("ctn_491") ?> <?php echo $this->settings->info->payment_symbol ?>30.00 <?php echo lang("ctn_490") ?>"
...
<div class="row">
    ...
    <div class="col-md-4">
        <form action='https://www.2checkout.com/checkout/purchase' method='post'>
                ...
                <input type="hidden" name="currency_code" value="<?php echo $this->settings->info->paypal_currency ?>" />
                <input name='submit' type='submit' value='<?php echo lang("ctn_491") ?> <?php echo $this->settings->info->payment_symbol ?>5.00 <?php echo lang("ctn_490") ?>' />
                </form>
    </div>
    <div class="col-md-4">
        <form action='https://www.2checkout.com/checkout/purchase' method='post'>
                ...
                <input type="hidden" name="currency_code" value="<?php echo $this->settings->info->paypal_currency ?>" />
                <input name='submit' type='submit' value='<?php echo lang("ctn_491") ?> <?php echo $this->settings->info->payment_symbol ?>10.00 <?php echo lang("ctn_490") ?>' />
                </form>
    </div>
    <div class="col-md-4">
        <form action='https://www.2checkout.com/checkout/purchase' method='post'>
                ...
                <input type="hidden" name="currency_code" value="<?php echo $this->settings->info->paypal_currency ?>" />
                <input name='submit' type='submit' value='<?php echo lang("ctn_491") ?> <?php echo $this->settings->info->payment_symbol ?>30.00 <?php echo lang("ctn_490") ?>' />
                </form>
    </div>
</div>
<?php endif; ?>
