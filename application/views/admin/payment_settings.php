...
<div class="form-group">
    <label for="name-in" class="col-sm-2 control-label"><?php echo lang("ctn_451") ?></label>
    <div class="col-sm-10">
...
<div class="form-group">
    <label for="name-in" class="col-sm-2 control-label"><?php echo lang("ctn_452") ?></label>
    <div class="col-sm-10">
...
<div class="form-group">
    <label for="name-in" class="col-sm-2 control-label"><?php echo lang("ctn_453") ?></label>
    <div class="col-sm-10">
        <input type="text" name="checkout2_accountno" class="form-control" value="<?php echo $this->settings->info->checkout2_accountno ?>" />
    </div>
</div>
<div class="form-group">
    <label for="name-in" class="col-sm-2 control-label"><?php echo lang("ctn_454") ?></label>
    <div class="col-sm-10">
        <input type="text" name="checkout2_secret" class="form-control" value="<?php echo $this->settings->info->checkout2_secret ?>" />
    </div>
</div>
