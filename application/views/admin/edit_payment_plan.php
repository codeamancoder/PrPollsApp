...
<div class="form-group">
 ...
 <div class="form-group">
        <label for="username-in" class="col-md-3 label-heading"><?php echo lang("ctn_338") ?></label>
        <div class="col-md-9">
            <input type="text" class="form-control" id="votes" name="votes" value="<?php echo $plan->votes ?>">
            <span class="help-block"><?php echo lang("ctn_339") ?></span>
        </div>
</div>
